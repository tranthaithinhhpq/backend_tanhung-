...
var _workingSlotTemplateService = _interopRequireDefault(require("../service/workingSlotTemplateService"));
...
var getPaginate = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
    var page, limit, doctorName, result;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          _context.n = 1;
          return _workingSlotTemplateService["default"].getPaginate(page, limit, doctorName);
        case 1:
          result = _context.v;
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res) {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _context2.n = 1;
          return _workingSlotTemplateService["default"].create(req.body);
        case 1:
          result = _context2.v;
  ...
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(req, res) {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          _context3.n = 1;
          return _workingSlotTemplateService["default"].update(req.params.id, req.body);
        case 1:
          result = _context3.v;
  ...
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(req, res) {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.n) {
        case 0:
          _context4.n = 1;
          return _workingSlotTemplateService["default"].remove(req.body.id);
        case 1:
          result = _context4.v;
