    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          offset = (page - 1) * limit;
          _context.n = 1;
          return _index["default"].PageVideoContent.findAndCountAll({
            offset: offset,
            limit: limit,
            order: [['sortOrder', 'ASC'], ['createdAt', 'DESC']]
          });
        case 1:
          _yield$db$PageVideoCo = _context.v;
          count = _yield$db$PageVideoCo.count;
          rows = _yield$db$PageVideoCo.rows;
          return _context.a(2, {
            EC: 0,
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(data) {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _context2.n = 1;
          return _index["default"].PageVideoContent.create(data);
        case 1:
          item = _context2.v;
  ...
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(id, data) {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          _context3.n = 1;
          return _index["default"].PageVideoContent.findByPk(id);
        case 1:
          item = _context3.v;
          if (item) {
            _context3.n = 2;
