...
var handleImageUpload = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          fullPath = req.file.path; // vd: src/public/images/abc.png
          // Chuẩn hoá: chuyển \\ -> / và loại bỏ 'src/public/' để tạo path public
          relativePath = fullPath.replace(/\\\\|\\/g, "/").replace("src/public/", "");
  ...
  return function handleImageUpload(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var handleDeleteFile = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res) {
    var filename, filePath, _t2;
      ...
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          return _context2.a(2, res.status(400).json({
            message: "Thiếu tên file cần xóa"
          }));
        case 1:
          filePath = _path["default"].join(__dirname, '..', 'public', 'images', filename);
        ...
        case 4:
          _context2.p = 4;
          _t2 = _context2.v;
          console.error("Xóa file thất bại:", _t2);
  ...
  return function handleDeleteFile(_x3, _x4) {
