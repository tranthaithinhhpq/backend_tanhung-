...
var _degreeService = _interopRequireDefault(require("../service/degreeService"));
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return _models["default"].Degree.findAll({
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res) {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _context2.n = 1;
          return _degreeService["default"].getAll();
        case 1:
          result = _context2.v;
  ...
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(req, res) {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          _context3.n = 1;
          return _degreeService["default"].create(req.body);
        case 1:
          result = _context3.v;
  ...
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(req, res) {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.n) {
        case 0:
          _context4.n = 1;
          return _degreeService["default"].update(req.params.id, req.body);
        case 1:
          result = _context4.v;
  ...
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(req, res) {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.n) {
        case 0:
          _context5.n = 1;
          return _degreeService["default"].remove(req.body.id);
        case 1:
          result = _context5.v;
...
var getPaginate = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.n) {
        case 0:
          ...
          _context6.n = 1;
          return _degreeService["default"].getPaginate(page, limit);
        case 1:
          data = _context6.v;
  ...
  return function getPaginate(_x1, _x10) {
