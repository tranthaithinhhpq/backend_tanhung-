    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          doctorName = _args.length > 2 && _args[2] !== undefined ? _args[2] : '';
          offset = (page - 1) * limit;
          whereClause = {};
          include = [{
            ...
            where: doctorName ? {
              doctorName: _defineProperty({}, _index["default"].Sequelize.Op.like, "%".concat(doctorName, "%"))
            } : undefined
          }];
          _context.n = 1;
          return _index["default"].WorkingSlotTemplate.findAndCountAll({
            where: whereClause,
            offset: offset,
            limit: limit,
        ...
        case 1:
          _yield$db$WorkingSlot = _context.v;
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(data) {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _context2.n = 1;
          return _index["default"].WorkingSlotTemplate.create(data);
        case 1:
          item = _context2.v;
  ...
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(id, data) {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          _context3.n = 1;
          return _index["default"].WorkingSlotTemplate.findByPk(id);
        case 1:
          item = _context3.v;
          if (item) {
            _context3.n = 2;
