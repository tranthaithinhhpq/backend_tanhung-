    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          offset = (page - 1) * limit;
          _context.n = 1;
          return _index["default"].PageTextContent.findAndCountAll({
            offset: offset,
            limit: limit,
            order: [['sortOrder', 'ASC'], ['createdAt', 'DESC']]
          });
        case 1:
          _yield$db$PageTextCon = _context.v;
          count = _yield$db$PageTextCon.count;
          rows = _yield$db$PageTextCon.rows;
          return _context.a(2, {
            EC: 0,
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(data) {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _context2.n = 1;
          return _index["default"].PageTextContent.create(data);
        case 1:
          item = _context2.v;
  ...
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(id, data) {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          _context3.n = 1;
          return _index["default"].PageTextContent.findByPk(id);
        case 1:
          item = _context3.v;
          if (item) {
            _context3.n = 2;
...
var getBySectionList = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        case 0:
          sections = _args5.length > 0 && _args5[0] !== undefined ? _args5[0] : [];
          _context5.p = 1;
          _context5.n = 2;
        ...
        case 3:
          _context5.p = 3;
          _t = _context5.v;
          console.error('getBySectionList error:', _t);
          return _context5.a(2, {
            EC: -1,
            EM: 'Error',
            DT: []
  ...
  return function getBySectionList() {
    return _ref5.apply(this, arguments);
  };
}();
var _default = exports["default"] = {
  getBySectionList: getBySectionList,
