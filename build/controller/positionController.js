...
var _positionService = _interopRequireDefault(require("../service/positionService"));
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return _models["default"].Position.findAll({
            attributes: ["id", "name", "description"]
          });
        case 1:
          positions = _context.v;
...
var getPaginate = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          ...
          _context2.n = 1;
          return _positionService["default"].getPaginate(page, limit);
        case 1:
          result = _context2.v;
  ...
  return function getPaginate(_x3, _x4) {
  ...
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(req, res) {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          _context3.n = 1;
          return _positionService["default"].create(req.body);
        case 1:
          result = _context3.v;
  ...
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(req, res) {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.n) {
        case 0:
          _context4.n = 1;
          return _positionService["default"].update(req.params.id, req.body);
        case 1:
          result = _context4.v;
  ...
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(req, res) {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.n) {
        case 0:
          _context5.n = 1;
          return _positionService["default"].remove(req.body.id);
        case 1:
          result = _context5.v;
