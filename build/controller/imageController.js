...
var _imageService = _interopRequireDefault(require("../service/imageService"));
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return _imageService["default"].getAllImages();
        case 1:
          images = _context.v;
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          console.error("❌ getImages error:", _t);
          return _context.a(2, res.status(500).json({
            EC: 1,
            EM: 'Lỗi lấy danh sách ảnh',
            DT: []
          }));
      }
    }, _callee, null, [[0, 2]]);
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          _context2.n = 1;
          return _imageService["default"].deleteImage(filename);
        case 1:
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          console.error("❌ removeImage error:", _t2);
